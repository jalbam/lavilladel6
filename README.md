...
Recently (27 September 2018), a new package was added so it can be played offline on Windows XP with SP2 (Service Pack 2) and newer (including Windows 10) by using the [php-webkit](https://github.com/baconbrad/php-webkit) version provided, available to download in "*[the la_villa_del_seis_php-webkit_win32.zip](the la_villa_del_seis_php-webkit_win32.zip)*" or the "*[la_villa_del_seis_php-webkit_win32.7z](la_villa_del_seis_php-webkit_win32.7z)*" file. There is an installer for the same version to download in the "*la_villa_del_seis_php-webkit_win32_installer.exe*" file. For older Windows versions (older than Windows XP with SP2), there is a version which uses [Server2Go](https://sourceforge.net/projects/server2go/) available to download in the "*[la_villa_del_seis_on_server2go.zip](la_villa_del_seis_on_server2go.zip)*" file.

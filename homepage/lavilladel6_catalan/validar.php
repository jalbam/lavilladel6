...
else if ($HTTP_SESSION_VARS["estancia"] == $lugar_para_acabar_el_juego) { echo "<center><table border=\"1\" bordercolor=\"#333333\" cellspacing=\"0\" cellpadding=\"5\" width=\"400\" align=\"center\" style=\"border:1px solid #333333;\"><tr><td width=\"400\" align=\"center\" style=\"font-family:courier; font-size:14px; color:#ffffff; border:1px solid #333333;\"><center>El joc ha terminat.</center></td></tr></table></center><br>"; }
...
//    print_r($comando_matriz);
    ...
    if (sizeof($comando_matriz) == 1)
     {
        if ($comando_matriz[0] == "SUD" || $comando_matriz[0] == "S" || $comando_matriz[0] == "SUR") { realizar_accion("ANAR", "SUD"); } //Se ejecuta IR SUR.
        elseif ($comando_matriz[0] == "NORD" || $comando_matriz[0] == "N" || $comando_matriz[0] == "NORTE") { realizar_accion("ANAR", "NORD"); } //Se ejecuta IR NORTE.
        elseif ($comando_matriz[0] == "EST" || $comando_matriz[0] == "E" || $comando_matriz[0] == "ESTE") { realizar_accion("ANAR", "EST"); } //Se ejecuta IR ESTE.
        elseif ($comando_matriz[0] == "OEST" || $comando_matriz[0] == "O" || $comando_matriz[0] == "OESTE") { realizar_accion("ANAR", "OEST"); } //Se ejecuta IR OESTE.
        else { echo "<center><b>Tens d'escriure m&eacute;s.</b></center>"; }
     }
...
//        if ($comando_matriz[2] != "CON" && $comando_matriz[2] != "A" && $comando_matriz[2] != "EN" && $comando_matriz[2] != "AL" && $comando_matriz[2] != "HA" && $comando_matriz[2] != "AH" && $comando_matriz[2] != "KON") {
        if ($comando_matriz[2] != "CON" && $comando_matriz[2] != "AMB" && $comando_matriz[2] != "A" && $comando_matriz[2] != "EN" && $comando_matriz[2] != "AL" && $comando_matriz[2] != "HA" && $comando_matriz[2] != "AH" && $comando_matriz[2] != "KON" && $comando_matriz[4] != "CON" && $comando_matriz[4] != "A" && $comando_matriz[4] != "EN" && $comando_matriz[4] != "AL" && $comando_matriz[4] != "HA" && $comando_matriz[4] != "AH" && $comando_matriz[4] != "KON") {
        realizar_accion($comando_matriz[0], $comando_matriz[1], $comando_matriz[3], $comando_matriz[4], $comando_matriz[2], $comando_matriz[5]);
        } else { echo "Massa par&agrave;metres."; }
    }

    elseif (sizeof($comando_matriz > 6)) { echo "Massa par&agrave;metres."; }

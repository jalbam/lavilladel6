...
//            else if (isset($HTTP_GET_VARS["javascript_soportado"])) { $HTTP_SESSION_VARS["javascript_soportado_invisibilidad"] = (urldecode(trim($HTTP_GET_VARS["javascript_soportado"])) == "si" || isset($HTTP_SESSION_VARS["javascript_soportado_invisibilidad"]) && $HTTP_SESSION_VARS["javascript_soportado_invisibilidad"] == "si") ? "hidden": "visible"; }
        ...
        <!--
            ...
            {
                if (document.getElementById) { document.getElementById('mapa_y_ayuda').innerHTML = '<font size="2"><a href="javascript:abrir_mapa(<?php if (isset($HTTP_SESSION_VARS["estancia"])) { echo $HTTP_SESSION_VARS["estancia"]; } else { echo "0"; } ?>);" title="Abrir ventana con el mapa">Ver mapa</a> - <a href="javascript:abrir_ayuda();" title="Abrir ventana de ayuda">Ayuda</a></font>'; }
            }
 ...
 <!--   <body bgcolor="#000000" text="#ffffff" link="#bb7600" alink="#ff7600" vlink="#bb7600" onLoad="document.getElementById('formulario').comando.focus(); hacer_visible_todo(); mapa_y_ayuda(); <?php if ($HTTP_SESSION_VARS["estancia"] == $lugar_para_acabar_el_juego) { echo "document.getElementById('formulario').comando.style.background='#333333'; document.getElementById('formulario').comando.disabled = true;"; } else { echo "document.getElementById('formulario').comando.disabled = false; document.getElementById('formulario').comando.style.background='#dddddd';"; } ?>"> -->
    <body bgcolor="#000000" text="#ffffff" link="#bb7600" alink="#ff7600" vlink="#bb7600" onLoad="if (document.getElementById) { formulario = document.getElementById('formulario'); } else { formulario = document.formulario; }<?php if (!isset($HTTP_GET_VARS["javascript_soportado"])) { echo " formulario.comando.focus();"; } ?> hacer_visible_todo(); <?php if ($HTTP_SESSION_VARS["estancia"] == $lugar_para_acabar_el_juego) { echo "formulario.comando.style.background='#333333'; formulario.comando.disabled = true;"; } else { echo "formulario.comando.disabled = false; formulario.comando.style.background='#dddddd';"; } ?>" leftmargin="0" topmargin="10" marginwidth="0" marginheight="10">
        ...
        <img src="title.gif" width="400" height="43" alt="La villa del seis" title="La villa del seis" hspace="0" vscpace="0">
        <br>
        <br>
            ...
            <tr>
                <td align="center" bgcolor="#111111" style="font-family:arial; font-size:12px; color:#bbbbbb;">
                    ...
                    <form method="get" action="<?php echo $this_file; ?>" style="display:inline;" name="formulario" id="formulario" onSubmit="if (document.formulario.comando.value == '') { return false; }">
                        ...
                        [<a href="javascript:poner_texto('BORRAR');" alt="Borrar texto escrito" title="Borrar texto escrito">Borrar</a>] <input type="text" name="comando" value="" size="50" style="background-color:#dddddd; font-family:verdana; font-size:14px; line-height:18px; height:24px; border:1px solid #000000; padding-left:4px;" tabindex="1" accesskey="t" title="Orden a ejecutar (tecla de acceso r&aacute;pido: t)"> <input type="submit" name="boton" value="Ok" style="font-family:arial; font-weight:bold; cursor:pointer; cursor:hand; font-size:12px; line-height:12px; height:24px;" tabindex="2" accesskey="k" title="Ejecutar orden (tecla de acceso r&aacute;pido: k)">
                                    ...
                                    <tr>
                                        <td valign="top" align="center" style="border:1px solid #000000;">
                                            ...
                                            <table bgcolor="#111111" border="1" width="330" align="center" style="font-family:arial; font-size:14px; font-weight:bold; color:#bbbbbb; border:1px solid #000000;">
                                                <tr>
                                                    <td align="center" style="border:1px solid #555555;" width="110"><b><a href="javascript:poner_texto('COGER');" alt="COGER" title="COGER">COGER</a></b></td>
                                                    <td align="center" style="border:1px solid #555555;" width="110"><b><a href="javascript:poner_texto('USAR');" alt="USAR" title="USAR">USAR</a></b> (<a href="javascript:poner_texto('CON');" alt="CON" title="CON">CON</a>)</td>
                                                    <td align="center" style="border:1px solid #555555;" width="110"><b><a href="javascript:poner_texto('DAR');" alt="DAR" title="DAR">DAR</a></b> (<a href="javascript:poner_texto('A');" alt="A" title="A">A</a>)</td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="border:1px solid #555555;" width="110"><b><a href="javascript:poner_texto('IR');" alt="IR" title="IR">IR</a></b></td>
                                                    ...
                                                    <td align="center" style="border:1px solid #555555;" width="110"><b><a href="javascript:poner_texto('MOVER');" alt="MOVER" title="MOVER">MOVER</a></b></td>
                                                </tr>
                                            </table>
                                            <?php
                                                $n = (isset($lugar[$HTTP_SESSION_VARS["estancia"]]["NORTE"]) && $lugar[$HTTP_SESSION_VARS["estancia"]]["NORTE"] && $HTTP_SESSION_VARS["lugares"][$lugar[$HTTP_SESSION_VARS["estancia"]]["NORTE"]]) ? $lugar[$HTTP_SESSION_VARS["estancia"]]["NORTE"] : "\'no\'";
                                                $s = (isset($lugar[$HTTP_SESSION_VARS["estancia"]]["SUR"]) && $lugar[$HTTP_SESSION_VARS["estancia"]]["SUR"] && $HTTP_SESSION_VARS["lugares"][$lugar[$HTTP_SESSION_VARS["estancia"]]["SUR"]]) ? $lugar[$HTTP_SESSION_VARS["estancia"]]["SUR"] : "\'no\'";
                                                $e = (isset($lugar[$HTTP_SESSION_VARS["estancia"]]["ESTE"]) && $lugar[$HTTP_SESSION_VARS["estancia"]]["ESTE"] && $HTTP_SESSION_VARS["lugares"][$lugar[$HTTP_SESSION_VARS["estancia"]]["ESTE"]]) ? $lugar[$HTTP_SESSION_VARS["estancia"]]["ESTE"] : "\'no\'";
                                                $o = (isset($lugar[$HTTP_SESSION_VARS["estancia"]]["OESTE"]) && $lugar[$HTTP_SESSION_VARS["estancia"]]["OESTE"] && $HTTP_SESSION_VARS["lugares"][$lugar[$HTTP_SESSION_VARS["estancia"]]["OESTE"]]) ? $lugar[$HTTP_SESSION_VARS["estancia"]]["OESTE"] : "\'no\'";
                                            ?>
                                            <div id="mapa_y_ayuda" style="font-family:arial; font-size:12px; color:#ffffff; background:transparent;"><font size="2"><a href="mapa.php?estancia=<?php if (isset($HTTP_SESSION_VARS["estancia"])) { echo $HTTP_SESSION_VARS["estancia"]; } else { echo "0"; } echo "&n=".$n."&s=".$s."&e=".$e."&o=".$o; if (SID) { echo "&".SID; } else { echo "&cookies=ok"; } ?>" target="_blank" title="Abrir ventana con el mapa">Ver mapa</a> - <a href="ayuda.php?<?php echo $sesion; ?>" target="_blank" title="Abrir ventana de ayuda">Ayuda</a></font></div>
                                            <script language="JavaScript">
                                                <!--
                                                if (document.getElementById) { document.getElementById('mapa_y_ayuda').innerHTML = '<font size="2"><a href="javascript:abrir_mapa(<?php if (isset($HTTP_SESSION_VARS["estancia"])) { echo $HTTP_SESSION_VARS["estancia"]; } else { echo "0"; } echo ", ".$n.", ".$s.", ".$e.", ".$o; ?>);" title="Abrir ventana con el mapa">Ver mapa</a> - <a href="javascript:abrir_ayuda();" title="Abrir ventana de ayuda">Ayuda</a></font>'; }
                                                // -->
                                            </script>
                                            </center>
                                        </td>
...
<!--        <table width="580" height="10" border="0" bgcolor="#000000" cellspacing="0" cellpadding="0"><tr><td align="right" bgcolor="#000000" width="580"><table cellspacing="0" cellpadding="0" align="right" bgcolor="#aaaabb" width="300"><tr><td bgcolor="#aaaabb" align="center"><center><i>dedicado a</i> Yasmina Llaveria del Castillo</center></td></tr></table></td></tr></table> -->
        ...
        <font size="1" color="#bbbbbb" face="arial" style="font-family:verdana; font-size:9px; font-weight:bold;">
            <b>Programa por Yasmina Llaveria del Castillo (<a href="mailto:yas@granvino.com">yas@granvino.com</a>) y Joan Alba Maldonado (<a href="mailto:granvino@granvino.com">granvino@granvino.com</a>)</b>
        </font>
        <br>
        <font size="1" color="#888888" face="arial" style="font-family:arial; font-size:9px; font-weight:normal;">
            Fotograf&iacute;as 18.jpg, 23.jpg, 34.jpg, 40.jpg, 41.jpg por Esteban Villegas Gallego (<a href="mailto:esteban_hiv@hotmail.com">esteban_hiv@hotmail.com</a>)
        </font>
